...
class CommentService extends Service {
  async create({ article_id, user_id, content, reply_to_comment_id, reply_to_user_id }) {
    return await this.ctx.model.Comment.create({ article_id, user_id, content, reply_to_comment_id, reply_to_user_id });
  }
